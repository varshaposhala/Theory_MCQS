...
const prompts_paraphrase_json_file_name = parent_json_file_name + "_tags.json";
const prompts_paraphrase_path = "./Tags/" + prompts_paraphrase_json_file_name;
const responses_paraphrase_path = "./responses_tags/" + parent_json_file_name + "_r_tags.json";
